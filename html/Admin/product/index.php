            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container my-3">
                        <form class="row g-3 m-auto" autocomplete="off" action="/product/app/product/insert.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group">
                                ...
                                <input required type="number" class="form-control" name="Product_price" placeholder="Price">
                            </div>
                            <div class="input-group">
