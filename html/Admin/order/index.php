    ...
    <div class="container">
        <section style="background-color: #eee;" class="shadow rounded ps-5 pe-5">
            <div class="container my-5 py-4">
                <div>
                    <a href="/product/html/Admin/home/" class="bi bi-arrow-left-square fs-5 btn btn-success"></a>
                </div>
                        ...
                        <tbody id="Search_table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/product/app/order/delete.php?Order_id=<?php echo $row['order_id'] ?>" class="btn btn-danger bi bi-trash"></a>
                                    </td>
                                </tr>
                            <?php
                            }
